...
function index(props) {
    ...
    return (
        <Layout>
            ...
            <div className="white p2 flex a-center" ></div>
            <img className={['centered']} src='https://www.ashdowngroup.com/wp-content/uploads/2019/06/Dell_EMC_logo.svg.png' width='140px' height='25px'/>
